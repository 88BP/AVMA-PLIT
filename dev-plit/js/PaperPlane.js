...
jQuery(document).ready(function () {
    ...
    Data Spy
    ========================================================================== */
    jQuery('body').attr('data-spy', 'scroll').attr('data-target', '#nav-wrapper').attr('data-offset', '125');
	...
	if (onMobile === true) {
        ...
        jQuery('.video-background #home-section').css({background: 'url(images/background/homebg.gif) center center'});
        ...
        if (jQuery('body').hasClass('video-background')) {
            ...
            jQuery(function () {
                jQuery('.video-background #home-section').okvideo({
                    ...
                    autoplay: true,
                    annotations: false,
                    source: 'https://www.youtube.com/watch?v=YFu_lhUa7E4'
                });
            });
        }
    ...
    //     myLatlng = new google.maps.LatLng(42.0650056,-88.0419965);
    //     mapOptions = {
    //         zoom: 16,
    //         panControl: false,
    //         scrollwheel: false,
...
$(window).scroll(function() {
    if ($(this).scrollTop() >= 50) {        // If page is scrolled more than 50px
        ...
        $('#scroll-down').fadeIn(0);   // Else fade out the arrow
    }
});
...
$(window).ready(function() {
        $('#scroll-down').delay(0).fadeIn(1000);    // Fade in the arrow
});